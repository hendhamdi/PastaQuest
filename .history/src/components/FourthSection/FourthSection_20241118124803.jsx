...
const FourthSection = () => {
  return (
    <div className="fourth-section">
      ...
      <div className="fourth-section-events">
        <div className="event-card-home">
          <img src={eventImage1} alt="Soirée Jazz" className="event-image" />
          <h3 className="event-title">Soirées à thème</h3>
          <p className="event-description-home">Découvrez des soirées spéciales autour <br/>d'un thème culinaire ou festif.</p>
        </div>
        <div className="event-card">
          <img src={eventImage2} alt="Soirée Italienne" className="event-image" />
          <h3 className="event-title">Promotions exclusives</h3>
          <p className="event-description">Bénéficiez de réductions et d'offres <br/>spéciales lors de nos événements.</p>
        </div>
        <div className="event-card">
          <img src={eventImage3} alt="Happy Hour" className="event-image" />
          <h3 className="event-title">Dîners privés</h3>
          <p className="event-description">Réservez une salle pour vos événements <br/>privés,qu'il s'agisse de fêtes d'anniversaire, <br/>de réunions d'affaires, ou de célébrations familiales.</p>
        </div>
        <div className="event-card">
          <img src={eventImage4} alt="Soirée à Thème" className="event-image" />
          <h3 className="event-title">Concerts live</h3>
          <p className="event-description">Profitez de groupes et artistes locaux <br/>pendant votre dîner.</p>
        </div>
      </div>
