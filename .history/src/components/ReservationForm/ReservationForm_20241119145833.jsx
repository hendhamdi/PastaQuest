...
app.post('/reservation', async (req, res) => {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: 'gmail', // Utiliser un autre service si nécessaire
      auth: {
        user: process.env.EMAIL_USER, // Utiliser la variable d'environnement
        pass: process.env.EMAIL_PASS  // Utiliser la variable d'environnement
      }
    });
