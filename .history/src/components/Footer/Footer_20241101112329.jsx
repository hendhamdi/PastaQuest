...
import instaImage1 from '../../Images/insta/img1.jpg';
import instaImage2 from '../../Images/insta/img2.jpg';
import instaImage3 from '../../Images/insta/img3.jpg';
import instaImage4 from '../../Images/insta/img4.jpg';
...
const Footer = () => {
  return (
    <footer className="footer">
      ...
      <div className="footer-section">
        <h3>Informations</h3>
        <p>Horaires d'ouverture: 09:00 - 22:00</p>
