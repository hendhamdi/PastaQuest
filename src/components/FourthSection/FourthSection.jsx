...
const FourthSection = () => {
  return (
    <div className="fourth-section-home">
      <div className="fourth-section-content-home">
        <h2 className="fourth-section-title-home">Événements Spéciaux<br />et Soirées à Thème</h2>
        <p className="fourth-section-description-home">
      ...
      <div className="fourth-section-events-home">
        ...
        <div className="event-card-home">
          ...
          <p className="event-description-home">Réservez une salle pour vos événements <br/>privés,
          qu'il s'agisse de fêtes d'anniversaire, <br/>de réunions d'affaires, ou de célébrations familiales.</p>
        </div>
        <div className="event-card-home">
