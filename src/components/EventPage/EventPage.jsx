    ...
    <div className="event-page-container">
      ...
      <div className="event-list">
        <div className="event-item">
          ...
          <p><strong>Description :</strong> Participez à notre soirée de dégustation de vins, accompagnée de plats de
           pâtes spécialement sélectionnés pour mettre en valeur les saveurs.</p>
        ...
        <div className="event-item">
          ...
          <p><strong>Description :</strong> Apprenez à préparer vos propres plats de pâtes avec notre chef ! 
          Profitez d’une expérience interactive et repartez avec vos créations.</p>
        ...
        <div className="event-item">
          ...
          <p><strong>Heure :</strong> 20h00 - 00h00</p>
          <p><strong>Description :</strong> Détendez-vous avec un concert de jazz 
          en direct dans notre espace extérieur. Profitez de notre menu tout en écoutant de la belle musique !</p>
